  ...
  return (
    <>
      <Layout>
        ...
        image={
         "https://i.ibb.co/0ZRbzxT/gatsby-icon-copy.png"
        }
      ...
      {data.markdownRemark.tableOfContents.length && (
        ...
        >
          <AiOutlineAlignLeft
            style={{ display: "inline-block", marginRight: "0.5rem",fontSize:"15px" }}
          />
          <Text fontSize="15px" display="inline-block">
          目录
            </Text>
          <Box mt="1rem">
            <RightSidebar input={data.markdownRemark.tableOfContents} />
          </Box>
        </Box>
      )}
    </>
